...
public enum Move {
	...
	DRAGON_TAIL(60,90,100,0,0,-6,PType.DRAGON,"% chance to switch out foe",true,10),
	...
	METRONOME(-1,1000,0,0,2,0,PType.MAGIC,"Uses a random move!",false,20),
	...
	FIERY_DANCE(80,100,50,0,2,0,PType.FIRE,"% chance to raise user's Sp.Atk by 1",false,10),
	...
	PHOTON_GEYSER(130,90,100,0,1,0,PType.LIGHT,"Lowers user's Sp.Atk by 2",false,5),
	...
	SNORE(50,100,0,0,1,0,PType.NORMAL,"This attack only works if the user is asleep",false,25),
