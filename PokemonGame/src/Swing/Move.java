...
public enum Move {
	...
	AURORA_VEIL(0,1000,0,0,2,0,PType.ICE,"Can only be used in SNOW, reduces both physical and special damage recieved for 5 turns",false,10),
	...
	BABY$DOLL_EYES(0,100,0,0,2,1,PType.LIGHT,"",false,30),
	...
	BIND(15,85,100,0,0,0,PType.NORMAL,"",true,20),
	...
	BLACK_HOLE_ECLIPSE(140,100,100,0,1,0,PType.GALACTIC,"",false,5),
	BLAZE_KICK(90,100,10,1,0,0,PType.FIRE,"",true,10),
	...
	BLIZZARD(110,70,20,0,1,0,PType.ICE,"",false,5),
	BLUE_FLARE(130,85,20,0,1,0,PType.FIRE,"% chance to Burn foe",false,5),
	BODY_PRESS(80,100,0,0,0,0,PType.FIGHTING,"",true,10),
	...
	BULLDOZE(60,100,100,0,0,0,PType.GROUND,"",false,20),
	BULLET_PUNCH(40,100,0,0,0,1,PType.STEEL,"Always goes first",true,15),
	BURN_UP(130,100,100,0,0,0,PType.FIRE,"",false,5),
	//BUZZ(0,100,0,0,2,0,PType.BUG,"Confuses foe",false,1),
	CALM_MIND(0,1000,0,0,2,0,PType.MAGIC,"Raises user's Sp.Atk and Sp.Def by 1",false,10),
	CHANNELING_BLOW(65,100,0,3,0,0,PType.FIGHTING,"",true,15),
	...
	CHARGE_BEAM(50,90,50,0,1,0,PType.ELECTRIC,"",false,10),
	CHARM(0,100,0,0,2,0,PType.LIGHT,"Lowers foe's Attack by 2",false,15),
	CIRCLE_THROW(60,90,100,0,0,-6,PType.FIGHTING,"",true,10),
	...
	DARKEST_LARIAT(85,100,0,0,0,0,PType.DARK,"",true,10),
	DAZZLING_GLEAM(80,100,0,0,1,0,PType.LIGHT,"",false,10),
	...
	DEFOG(0,1000,0,0,2,0,PType.FLYING,"",false,15),
	DESOLATE_VOID(65,85,50,0,1,0,PType.GALACTIC,"",false,10),
	...
	DETECT(0,1000,0,0,2,4,PType.FIGHTING,"",false,5),
	DIAMOND_STORM(100,95,50,0,0,0,PType.FIGHTING,"",false,5),
	DIG(80,100,0,0,0,0,PType.GROUND,"",true,15),
	DISCHARGE(80,100,30,0,1,0,PType.ELECTRIC,"% chance to Paralyze foe",false,15),
	DIVE(80,100,0,0,0,0,PType.WATER,"A normal attack",true,15),
	...
	DRAGON_DARTS(50,100,0,0,0,0,PType.DRAGON,"",false,10),
	...
	DRAGON_TAIL(60,90,100,0,0,-6,PType.DRAGON,"",true,10),
	DRAIN_PUNCH(75,100,0,0,0,0,PType.FIGHTING,"",true,10),
	DRAINING_KISS(50,100,0,0,1,0,PType.LIGHT,"",true,10),
	...
	DUAL_CHOP(40,90,0,0,0,0,PType.DRAGON,"",true,15),
	DYNAMIC_PUNCH(100,50,100,0,0,0,PType.FIGHTING,"% chance to confuse foe",false,5),
	...
	ELEMENTAL_SPARKLE(45,90,0,0,1,0,PType.MAGIC,"",false,10),
	EMBER(40,100,10,0,1,0,PType.FIRE,"% chance to Burn foe",false,25),
	ENCORE(0,100,0,0,2,0,PType.NORMAL,"",false,5),
	ENDEAVOR(0,100,0,0,0,0,PType.NORMAL,"",true,5),
	ENDURE(0,1000,0,0,2,4,PType.NORMAL,"",false,10),
	ENERGY_BALL(90,100,10,0,1,0,PType.GRASS,"",false,10),
	...
	FALSE_SURRENDER(80,1000,0,0,0,0,PType.DARK,"",true,10),
	FATAL_BIND(70,85,100,0,0,0,PType.BUG,"Causes foe to faint in 3 turns",true,3),
	FEATHER_DANCE(0,100,0,0,2,0,PType.FLYING,"Lowers foe's Attack by 2",false,15),
	FEINT(30,100,0,0,0,2,PType.NORMAL,"",false,10),
	...
	FELL_STINGER(50,100,0,0,0,0,PType.BUG,"",true,15),
	FIERY_DANCE(80,100,50,0,2,0,PType.FIRE,"",false,10),
	...
	FISSURE(0,30,0,0,0,0,PType.GROUND,"",false,5),
	...
	FLAME_CHARGE(50,100,100,0,0,0,PType.FIRE,"",true,15),
	...
	FLASH_RAY(40,100,50,0,1,0,PType.LIGHT,"",false,25),
	FLATTER(0,100,100,0,2,0,PType.DARK,"Confuses foe, and raises their Sp.Atk by 2",false,15),
	FLY(100,100,0,0,0,0,PType.FLYING,"A normal attack",true,5),
	FOCUS_BLAST(120,70,0,0,1,0,PType.FIGHTING,"",false,5),
	FOCUS_ENERGY(0,1000,0,0,2,0,PType.NORMAL,"",false,20),
	FORCE_PALM(60,100,30,0,0,0,PType.FIGHTING,"",true,10),
	...
	FORESTS_CURSE(0,100,0,0,2,0,PType.GRASS,"",false,20),
	FOUL_PLAY(95,100,0,0,0,0,PType.DARK,"",true,15),
	FREEZE$DRY(70,100,10,0,1,0,PType.ICE,"",false,15),
	...
	FRUSTRATION(-1,100,0,0,0,0,PType.NORMAL,"A normal attack",true,20),
	...
	FUSION_BOLT(100,100,0,0,0,0,PType.ELECTRIC,"",false,5),
	FUSION_FLARE(100,100,0,0,1,0,PType.FIRE,"",false,5),
	//GALAXY_ATTACK(115,90,30,0,0,0,PType.MAGIC,"% chance to inflict the foe with a random Status condition",false,1),
	GALAXY_BLAST(90,100,0,0,1,0,PType.GALACTIC,"",false,10),
	GASTRO_ACID(0,100,0,0,2,0,PType.POISON,"",false,20),
	GENESIS_SUPERNOVA(120,95,0,0,1,0,PType.GALACTIC,"",false,10),
	GEOMANCY(0,1000,0,0,2,0,PType.LIGHT,"",false,5),
	...
	GLACIATE(65,95,100,0,1,0,PType.ICE,"",false,10),
	...
	GLITTERING_SWORD(95,100,20,0,0,0,PType.LIGHT,"",true,10),
	GLITTERING_TORNADO(55,100,30,0,1,0,PType.LIGHT,"",false,25),
	GLITZY_GLOW(80,100,30,0,1,0,PType.LIGHT,"",false,15),
	GRASS_KNOT(-1,100,0,0,1,0,PType.GRASS,"A normal attack",true,20),
	GRASS_WHISTLE(0,55,0,0,2,0,PType.GRASS,"",false,15),
	...
	GRAVITY(0,1000,0,0,2,0,PType.GALACTIC,"Sets GRAVITY for 5 turns",false,10),
	...
	GUILLOTINE(0,30,0,0,0,0,PType.NORMAL,"",true,5),
	...
	HEALING_WISH(0,1000,0,0,2,0,PType.PSYCHIC,"",false,5),
	HEAT_CRASH(-1,100,0,0,0,0,PType.FIRE,"",true,10),
	HEAT_WAVE(95,90,10,0,1,0,PType.FIRE,"% to Burn foe",false,10),
	HEAVY_SLAM(-1,100,0,0,0,0,PType.STEEL,"",true,10),
	HEX(-1,100,0,0,1,0,PType.GHOST,"",false,10),
	HI_JUMP_KICK(130,90,0,0,0,0,PType.FIGHTING,"If this attack misses, user takes 50% of its max HP",true,10),
	HIDDEN_POWER(60,100,0,0,1,0,PType.NORMAL,"",false,15),
	...
	HORN_LEECH(75,100,0,0,0,0,PType.GRASS,"",true,10),
	HOWL(0,1000,0,0,2,0,PType.NORMAL,"Raises user's Attack by 1",false,20),
	HURRICANE(110,70,30,0,1,0,PType.FLYING,"",false,10),
	...
	ICE_BALL(-1,90,0,0,0,0,PType.ICE,"",true,20),
	ICE_BEAM(90,100,10,0,1,0,PType.ICE,"",false,10),
	ICE_FANG(65,95,10,0,0,0,PType.ICE,"",true,15),
	ICE_PUNCH(75,100,20,0,0,0,PType.ICE,"",true,15),
	ICE_SHARD(40,100,0,0,0,1,PType.ICE,"Always goes first",false,15),
	ICE_SPINNER(80,100,100,0,0,0,PType.ICE,"",true,10),
	ICICLE_CRASH(85,90,30,0,0,0,PType.ICE,"",false,10),
	ICICLE_SPEAR(25,100,0,0,0,0,PType.ICE,"",false,25),
	ICY_WIND(55,95,100,0,1,0,PType.ICE,"",false,15),
	...
	INFERNO(100,50,100,0,1,0,PType.FIRE,"",false,5),
	INFESTATION(20,100,100,0,1,0,PType.BUG,"",true,15),
	INGRAIN(0,1000,0,0,2,0,PType.GRASS,"",false,15),
	//INJECT(55,100,100,0,0,0,PType.BUG,"% to Poison foe, heals 50% of damage dealt",false,1),
	IRON_BLAST(85,90,30,0,1,0,PType.STEEL,"",false,20),
	...
	JAW_LOCK(80,100,100,0,0,0,PType.DARK,"",true,5),
	...
	LEAFAGE(40,100,0,0,0,0,PType.GRASS,"",false,35),
	...
	LIGHT_BEAM(60,100,20,0,1,0,PType.LIGHT,"",false,15),
	LIGHT_OF_RUIN(140,90,0,0,1,0,PType.LIGHT,"",false,5),
	LIGHT_SCREEN(0,1000,0,0,2,0,PType.PSYCHIC,"",false,15),
	LIQUIDATION(85,100,20,0,0,0,PType.WATER,"",true,10),
	LOAD_FIREARMS(0,100,0,0,2,0,PType.STEEL,"",false,10),
	LOCK$ON(0,1000,0,0,2,0,PType.NORMAL,"Raises user's Accuracy by 6",false,5),
	LOVELY_KISS(0,75,0,0,2,0,PType.NORMAL,"",false,5),
	LOW_KICK(-1,100,0,0,0,0,PType.FIGHTING,"Damage is based on how heavy foe is",true,20),
	LOW_SWEEP(65,100,100,0,0,0,PType.FIGHTING,"",true,15),
	LUNAR_DANCE(0,1000,0,0,2,0,PType.PSYCHIC,"",false,10),
	LUSTER_PURGE(70,100,50,0,1,0,PType.LIGHT,"",false,10),
	...
	MAGIC_POWDER(0,100,0,0,2,0,PType.MAGIC,"",false,15),
	...
	MAGNET_BOMB(60,1000,0,0,0,0,PType.STEEL,"",false,20),
	...
	MEAN_LOOK(0,100,0,0,2,0,PType.NORMAL,"",false,5),
	MEGA_DRAIN(40,100,0,0,1,0,PType.GRASS,"Heals 50% of damage dealt",false,15),
	MEGAHORN(120,85,0,0,0,0,PType.BUG,"",true,10),
	MEMENTO(0,100,0,0,2,0,PType.DARK,"",false,5),
	METAL_CLAW(50,95,10,0,0,0,PType.STEEL,"",true,30),
	...
	METEOR_ASSAULT(120,100,100,0,0,0,PType.GALACTIC,"",false,5),
	METEOR_MASH(90,90,20,0,0,0,PType.STEEL,"",true,10),
	MINIMIZE(0,1000,0,0,2,0,PType.GHOST,"Raises user's Evasion by 2",false,5),
	MIRROR_SHOT(65,85,30,0,1,0,PType.STEEL,"",false,10),
	MIRROR_MOVE(0,1000,0,0,1,0,PType.FLYING,"Uses the move last used by the foe, fails if foe hasn't used a move yet",false,15),
	MIST_BALL(70,100,50,0,1,0,PType.PSYCHIC,"",false,15),
	MOLTEN_CONSUME(50,100,100,0,0,1,PType.FIRE,"% chance to Burn foe",true,5),
	MOLTEN_LAIR(0,100,0,0,2,0,PType.FIRE,"",false,5),
	MOLTEN_STEELSPIKE(100,90,30,0,1,0,PType.STEEL,"",false,10),
	MOONBLAST(95,100,30,0,1,0,PType.LIGHT,"",false,5),
	MOONLIGHT(0,1000,0,0,2,0,PType.LIGHT,"Restores 1/2 of user's max HP",false,5),
	MORNING_SUN(0,1000,0,0,2,0,PType.LIGHT,"",false,5),
	MUD_BOMB(65,85,30,0,1,0,PType.GROUND,"% to lower foe's Accuracy by 1",false,10),
	MUD_SHOT(55,95,100,0,1,0,PType.GROUND,"",false,15),
	MUD$SLAP(20,100,100,0,1,0,PType.GROUND,"% to lower foe's Accuracy by 1",false,15),
	MUD_SPORT(0,1000,0,0,2,0,PType.GROUND,"",false,15),
	MUDDY_WATER(90,85,30,0,1,0,PType.WATER,"",false,10),
	MYSTICAL_FIRE(75,100,100,0,1,0,PType.FIRE,"",false,10),
	NASTY_PLOT(0,1000,0,0,2,0,PType.DARK,"",false,5),
	NEEDLE_ARM(90,100,30,0,1,0,PType.GRASS,"",true,10),
	...
	NIGHT_DAZE(85,95,40,0,0,0,PType.DARK,"",false,10),
	...
	NO_RETREAT(0,1000,0,0,2,0,PType.FIGHTING,"",false,5),
	NOBLE_ROAR(0,100,0,0,2,0,PType.NORMAL,"",false,30),
	NUZZLE(20,100,100,0,0,0,PType.ELECTRIC,"",true,10),
	OBSTRUCT(0,1000,0,0,2,4,PType.DARK,"",false,5),
	...
	PARABOLIC_CHARGE(65,100,0,0,1,0,PType.ELECTRIC,"",false,20),
	PAYBACK(-1,100,0,0,0,0,PType.DARK,"",true,10),
	...
	PETAL_BLIZZARD(90,100,0,0,0,0,PType.GRASS,"",false,15),
	PETAL_DANCE(120,100,0,0,1,0,PType.GRASS,"",true,10),
	PHANTOM_FORCE(100,100,0,0,0,0,PType.GHOST,"",true,10),
	PHOTON_GEYSER(130,90,100,0,1,0,PType.LIGHT,"",false,5),
	PIN_MISSILE(25,95,0,0,0,0,PType.BUG,"",false,15),
	PISTOL_POP(110,70,0,0,0,0,PType.STEEL,"",false,5),
	PLASMA_FISTS(100,100,0,0,0,0,PType.ELECTRIC,"",true,10),
	PLAY_NICE(0,100,0,0,2,0,PType.NORMAL,"",false,25),
	PLAY_ROUGH(90,90,10,0,0,0,PType.LIGHT,"",true,10),
	PLUCK(60,100,0,0,0,0,PType.FLYING,"",true,20),
	...
	POP_POP(70,80,0,0,0,0,PType.STEEL,"",false,5),
	...
	POWDER_SNOW(40,100,50,0,1,0,PType.ICE,"",false,25),
	POWER_GEM(80,100,0,0,1,0,PType.ROCK,"",false,20),
	POWER_WHIP(120,85,0,0,0,0,PType.GRASS,"",true,10),
	POWER$UP_PUNCH(40,100,100,0,0,0,PType.FIGHTING,"",true,10),
	PRISMATIC_LASER(100,100,0,0,1,0,PType.LIGHT,"",false,10),
	PROTECT(0,1000,0,0,2,4,PType.NORMAL,"",false,10),
	PSYBEAM(65,100,10,0,1,0,PType.PSYCHIC,"",false,20),
	PSYCHIC(90,100,10,0,1,0,PType.PSYCHIC,"",false,10),
	PSYCHIC_FANGS(85,100,100,0,0,0,PType.PSYCHIC,"",true,10),
	PSYCHIC_TERRAIN(0,1000,0,0,2,0,PType.PSYCHIC,"",false,15),
	PSYCHO_CUT(70,100,0,1,0,0,PType.PSYCHIC,"Boosted Crit rate",false,20),
	PSYSHOCK(80,100,0,0,1,0,PType.PSYCHIC,"",false,15),
	PSYWAVE(0,100,0,0,1,0,PType.PSYCHIC,"",false,15),
	...
	QUIVER_DANCE(0,1000,0,0,2,0,PType.BUG,"",false,10),
	RAGE(-1,100,0,0,0,0,PType.NORMAL,"Power increases the more times this move is used in succession",true,20),
	RAIN_DANCE(0,1000,0,0,2,0,PType.WATER,"",false,5),
	RAPID_SPIN(20,100,100,0,0,0,PType.NORMAL,"% to raise user's Speed by 1, and frees user of being Spun",true,35),
	RAZOR_LEAF(55,95,0,1,0,0,PType.GRASS,"Boosted Crit rate",false,25),
	RAZOR_SHELL(75,95,50,0,0,0,PType.WATER,"",true,10),
	REBOOT(0,1000,0,0,2,0,PType.STEEL,"Clears user or any Status condition, and raises user's Speed by 1",false,10),
	RECOVER(0,1000,0,0,2,0,PType.NORMAL,"",false,5),
	RED$NOSE_BOOST(0,1000,0,0,2,0,PType.MAGIC,"",false,10),
	REFLECT(0,1000,0,0,2,0,PType.PSYCHIC,"",false,20),
	REST(0,1000,0,0,2,0,PType.PSYCHIC,"",false,5),
	RETURN(-1,100,0,0,0,0,PType.NORMAL,"",true,15),
	REVENGE(-1,100,0,0,0,0,PType.FIGHTING,"Power is doubled if user is slower than foe",true,10),
	REVERSAL(-1,100,0,0,2,0,PType.FIGHTING,"",true,15),
	ROAR(0,1000,0,0,2,-6,PType.NORMAL,"",false,20),
	...
	ROCKFALL_FRENZY(75,95,100,0,1,0,PType.ROCK,"",false,10),
	...
	ROUND(60,100,0,0,1,0,PType.NORMAL,"",false,15),
	SACRED_FIRE(100,95,50,0,0,0,PType.FIRE,"",false,5),
	SACRED_SWORD(90,100,0,0,0,0,PType.FIGHTING,"",true,10),
	SAFEGUARD(0,1000,0,0,2,0,PType.NORMAL,"",false,20),
	...
	SEA_DRAGON(0,1000,0,0,2,0,PType.MAGIC,"",false,5),
	...
	SHADOW_CLAW(80,100,0,1,0,0,PType.GHOST,"",true,15),
	SHADOW_PUNCH(80,1000,0,0,0,0,PType.GHOST,"",true,20), // TODO: give to Poov line
	SHADOW_SNEAK(40,100,0,0,0,1,PType.GHOST,"Always attacks first",true,15),
	SHEER_COLD(0,30,0,0,1,0,PType.ICE,"",false,5),
	...
	SHIFT_GEAR(0,1000,0,0,2,0,PType.STEEL,"",false,10),
	...
	SILVER_WIND(60,100,10,0,1,0,PType.BUG,"",false,5),
	...
	SLACK_OFF(0,1000,0,0,2,0,PType.NORMAL,"",false,5),
	...
	SLUDGE_WAVE(95,100,10,0,1,0,PType.POISON,"",false,10),
	SMACK_DOWN(50,100,100,0,0,0,PType.ROCK,"",false,15),
	SMART_STRIKE(70,1000,0,0,0,0,PType.STEEL,"",false,10),
	...
	SNARL(55,95,100,0,1,0,PType.DARK,"",false,15),
	SNORE(50,100,0,0,1,0,PType.NORMAL,"",false,25),
	SOLAR_BEAM(120,100,0,0,1,0,PType.GRASS,"User must charge up on the first turn, attacks on the second",false,10),
	SOLAR_BLADE(125,100,0,0,0,0,PType.GRASS,"",true,10),
	SPACE_BEAM(60,100,30,0,1,0,PType.GALACTIC,"",false,20),
	SPACIAL_REND(100,95,0,1,1,0,PType.GALACTIC,"",false,5),
	SPARK(65,100,30,0,0,0,PType.ELECTRIC,"% to Paralyze foe",true,20),
	SPARKLE_STRIKE(80,1000,0,0,0,0,PType.MAGIC,"",true,15),
	SPARKLING_ARIA(90,100,100,0,1,0,PType.WATER,"",false,10),
	SPARKLING_TERRAIN(0,1000,0,0,2,0,PType.MAGIC,"",false,10),
	...
	SPARKLY_SWIRL(70,100,10,0,1,0,PType.MAGIC,"",false,15),
	SPECTRAL_THIEF(90,100,100,0,0,0,PType.GHOST,"",true,10),
	SPEEDY_SHURIKEN(40,100,0,0,0,1,PType.STEEL,"",false,15),
	SPIKE_CANNON(20,100,0,0,0,0,PType.NORMAL,"",false,15),
	...
	SPIKES(0,1000,0,0,2,0,PType.GROUND,"",false,20),
	//SPIKE_SLAM(65,90,0,0,0,0,PType.NORMAL,"A normal attack",false,1),
	SPIKY_SHIELD(0,1000,0,0,2,4,PType.GRASS,"",false,10),
	SPIRIT_BREAK(75,100,100,0,0,0,PType.LIGHT,"",true,15),
	SPLASH(0,1000,0,0,2,0,PType.NORMAL,"",false,40),
	STAR_STORM(110,85,0,0,1,0,PType.GALACTIC,"A normal attack",false,5),
	STAR_STRUCK_ARCHER(75,85,0,3,0,0,PType.GALACTIC,"",false,10),
	STEALTH_ROCK(0,1000,0,0,2,0,PType.ROCK,"",false,20),
	STEEL_BEAM(140,95,100,0,1,0,PType.STEEL,"",false,5),
	STEEL_WING(70,90,10,0,0,0,PType.STEEL,"",true,25),
	STICKY_WEB(0,1000,0,0,2,0,PType.BUG,"",false,10),
	STOCKPILE(0,1000,0,0,2,0,PType.NORMAL,"",false,20),
	...
	STRENGTH_SAP(0,100,0,0,2,0,PType.GRASS,"",false,10),
	...
	STRUGGLE_BUG(50,100,100,0,1,0,PType.BUG,"",false,20),
	//STRONG_ARM(90,85,30,0,0,0,PType.FIGHTING,"% chance of Paralyzing and/or causing foe to flinch",false,1),
	STUN_SPORE(0,75,0,0,2,0,PType.GRASS,"",false,25),
	SUBMISSION(80,90,0,0,0,0,PType.FIGHTING,"",true,20),
	SUCKER_PUNCH(80,100,0,0,0,2,PType.DARK,"Always attacks first. Fails if foe didn't use an attacking move",true,5),
	SUNNY_DAY(0,1000,0,0,2,0,PType.FIRE,"",false,5),
	SUNNY_DOOM(80,100,0,0,1,0,PType.LIGHT,"If this attack faints foe, causes weather to turn SUNNY",false,5),
	SUNSTEEL_STRIKE(100,100,0,0,0,0,PType.STEEL,"",true,5),
	...
	SUPERNOVA_EXPLOSION(200,100,0,0,1,0,PType.GALACTIC,"",false,5),
	...
	SWEET_KISS(0,75,0,0,2,0,PType.LIGHT,"",false,10),
	SWEET_SCENT(0,1000,0,0,2,0,PType.NORMAL,"",false,20),
	...
	TAUNT(0,100,0,0,2,0,PType.DARK,"",false,20),
	TEETER_DANCE(0,100,0,0,2,0,PType.NORMAL,"",false,20),
	TELEPORT(0,1000,0,0,2,-6,PType.PSYCHIC,"",false,10),
	THRASH(120,100,0,0,0,0,PType.NORMAL,"",true,10),
	THROAT_CHOP(80,100,100,0,0,0,PType.DARK,"",true,10),
	THUNDER(120,70,30,0,1,0,PType.ELECTRIC,"% of Paralyzing foe",false,5),
	...
	TOPSY$TURVY(0,1000,0,0,2,0,PType.DARK,"",false,20),
	TORMENT(0,100,0,0,2,0,PType.DARK,"",false,15),
	...
	UNSEEN_STRANGLE(60,100,100,0,0,0,PType.DARK,"",true,5),
	U$TURN(70,100,0,0,0,0,PType.BUG,"",true,15),
	...
	VOLT_SWITCH(70,100,0,0,1,0,PType.ELECTRIC,"",false,10),
	...
	WATER_SPOUT(-1,100,0,0,1,0,PType.WATER,"",false,5),
	WATER_SPORT(0,1000,0,0,2,0,PType.WATER,"",false,15),
	WAVE_CRASH(120,100,0,0,0,0,PType.WATER,"",false,10),
	...
	WEATHER_BALL(-1,100,0,0,1,0,PType.NORMAL,"",false,10),
	...
	WHIRLWIND(0,1000,0,0,2,-6,PType.FLYING,"",false,20),
	WILL$O$WISP(0,85,0,0,2,0,PType.FIRE,"Burns foe",false,15),
	WING_ATTACK(60,100,0,0,0,0,PType.FLYING,"A normal attack",true,35),
	WISH(0,1000,0,0,2,0,PType.NORMAL,"",false,10),
	WITHDRAW(0,1000,0,0,2,0,PType.WATER,"",false,35),
	WORRY_SEED(0,100,0,0,2,0,PType.GRASS,"",false,10),
	...
	ZAP_CANNON(120,50,100,0,1,0,PType.ELECTRIC,"",false,5),
	...
	ZING_ZAP(80,100,30,0,0,0,PType.ELECTRIC,"",true,15),
	
	TERRAIN_PULSE(-1,100,0,0,1,0,PType.NORMAL,"",false,10),
	FACADE(-1,100,0,0,0,0,PType.NORMAL,"",true,20),
	SLEEP_TALK(-1,100,0,0,2,0,PType.NORMAL,"",false,10),
	CAPTIVATE(-1,100,0,0,2,0,PType.NORMAL,"",false,10),
	BATON_PASS(-1,100,0,0,2,0,PType.NORMAL,"",false,3),
	FLIP_TURN(60,100,0,0,0,0,PType.WATER,"",true,10),
