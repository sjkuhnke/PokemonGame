...
public enum Item {
	...
	CHERI_BERRY(221,10,2,new Color(232, 96, 80),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to free itself from paralysis."),
	CHESTO_BERRY(222,10,2,new Color(144, 112, 224),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to wake itself from sleep."),
	PECHA_BERRY(223,10,2,new Color(248, 192, 152),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to lift the effects of being poisoned from itself."),
	RAWST_BERRY(224,10,2,new Color(144, 208, 208),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to cure itself of a burn."),
	ASPEAR_BERRY(225,10,2,new Color(240, 224, 80),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to thaw itself from a frostbite."),
	LUM_BERRY(226,100,10,new Color(144, 216, 72),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to cure itself of any status condition it may have."),
	PERSIM_BERRY(227,10,2,new Color(224, 152, 112),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to cure itself of confusion."),
	LEPPA_BERRY(228,75,10,new Color(200, 72, 48),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 10 PP to a move."),
	ORAN_BERRY(229,25,5,new Color(80, 160, 240),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 10 HP to itself."),
	SITRUS_BERRY(230,50,15,new Color(248, 232, 104),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 25% of HP to itself."),
	WIKI_BERRY(231,75,20,new Color(144, 112, 224),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 33% HP should it find itself in a pinch."),
	OCCA_BERRY(232,50,10,PType.FIRE.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Fire-type move, the power of that move will be weakened."),
	PASSHO_BERRY(233,50,10,PType.WATER.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Water-type move, the power of that move will be weakened."),
	WACAN_BERRY(234,50,10,PType.ELECTRIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Electric-type move, the power of that move will be weakened."),
	RINDO_BERRY(235,50,10,PType.GRASS.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Grass-type move, the power of that move will be weakened."),
	YACHE_BERRY(236,50,10,PType.ICE.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Ice-type move, the power of that move will be weakened."),
	CHOPLE_BERRY(237,50,10,PType.FIGHTING.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Fighting-type move, the power of that move will be weakened."),
	KEBIA_BERRY(238,50,10,PType.POISON.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Poison-type move, the power of that move will be weakened."),
	SHUCA_BERRY(239,50,10,PType.GROUND.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Ground-type move, the power of that move will be weakened."),
	COBA_BERRY(240,50,10,PType.FLYING.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Flying-type move, the power of that move will be weakened."),
	PAYAPA_BERRY(241,50,10,PType.PSYCHIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Psychic-type move, the power of that move will be weakened."),
	TANGA_BERRY(242,50,10,PType.BUG.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Bug-type move, the power of that move will be weakened."),
	CHARTI_BERRY(243,50,10,PType.ROCK.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Rock-type move, the power of that move will be weakened."),
	KASIB_BERRY(244,50,10,PType.GHOST.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Ghost-type move, the power of that move will be weakened."),
	HABAN_BERRY(245,50,10,PType.DRAGON.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Dragon-type move, the power of that move will be weakened."),
	COLBUR_BERRY(246,50,10,PType.DARK.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Dark-type move, the power of that move will be weakened."),
	BABIRI_BERRY(247,50,10,PType.STEEL.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Steel-type move, the power of that move will be weakened."),
	CHILAN_BERRY(248,50,10,PType.NORMAL.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Normal-type move, the power of that move will be weakened."),
	ROSELI_BERRY(249,50,10,PType.LIGHT.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Light-type move, the power of that move will be weakened."),
	MYSTICOLA_BERRY(250,50,10,PType.MAGIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Magic-type move, the power of that move will be weakened."),
	GALAXEED_BERRY(251,50,10,PType.GALACTIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Galactic-type move, the power of that move will be weakened."),
	LIECHI_BERRY(252,150,30,new Color(248, 224, 160),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Attack stat will be boosted should it find itself in a pinch."),
	GANLON_BERRY(253,75,15,new Color(152, 144, 200),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Defense stat will be boosted should it find itself in a pinch."),
	SALAC_BERRY(254,200,40,new Color(120, 184, 112),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Speed stat will be boosted should it find itself in a pinch."),
	PETAYA_BERRY(255,150,30,new Color(240, 160, 120),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Sp. Atk stat will be boosted should it find itself in a pinch."),
	APICOT_BERRY(256,75,15,new Color(104, 128, 184),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Sp. Def stat will be boosted should it find itself in a pinch."),
	STARF_BERRY(257,500,200,new Color(184, 232, 152),Item.BERRY,null,"If a Pokémon holds one of these Berries, one of its stats will be sharply boosted should it find itself in a pinch."),
	MICLE_BERRY(258,200,40,new Color(64, 200, 64),Item.BERRY,null,"If a Pokémon holds one of these Berries, its accuracy will be boosted should it find itself in a pinch."),
	CUSTAP_BERRY(259,200,40,new Color(220, 96, 70),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to act faster in a pinch—but only for the next move."),
