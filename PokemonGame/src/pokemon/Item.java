...
public enum Item {
	...
	ADAMANT_MINT(29,2500,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +Atk, -SpA"),
	BOLD_MINT(30,1750,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +Def, -Atk"),
	BRAVE_MINT(31,1000,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +Atk, -Spe"),
	CALM_MINT(32,1500,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +SpD, -Atk"),
	CAREFUL_MINT(33,1250,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +SpD, -SpA"),
	IMPISH_MINT(34,1750,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +Def, -SpA"),
	JOLLY_MINT(35,2500,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +Spe, -SpA"),
	MODEST_MINT(36,2250,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +SpA, -Atk"),
	QUIET_MINT(37,1000,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +SpA, -Spe"),
	SERIOUS_MINT(38,1250,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to Neutral"),
	TIMID_MINT(39,2500,0,new Color(113, 84, 255),Item.MEDICINE,null,"Changes a Pokemon's nature to +Spe, -Atk"),
	ELIXIR(40,200,0,new Color(230, 146, 78),Item.MEDICINE,null,"Restores PP of a selected move"),
	MAX_ELIXIR(41,250,0,new Color(246, 255, 120),Item.MEDICINE,null,"Restores PP of all moves on a Pokemon"),
	PP_UP(42,2500,0,new Color(150, 51, 156),Item.MEDICINE,null,"Increases max PP of a selected move by 20%"),
	PP_MAX(43,0,0,new Color(142, 230, 21),Item.MEDICINE,null,"Increases max PP of a selected move by its max PP, which is 160%"),
	EDGE_KIT(44,0,0,new Color(232, 52, 54),Item.OTHER,null,"Edges ;) your Pokemon until they're about to bust :{D"),
	THUNDER_SCALES_FOSSIL(45,5000,0,new Color(201, 169, 81),Item.OTHER,null,"A fossil of an ancient Pokemon that lived in a desert. It appears to have an electric charge ridden in the scales."),
	DUSK_SCALES_FOSSIL(46,5000,0,new Color(45, 47, 51),Item.OTHER,null,"A fossil of an ancient Pokemon that lived in a forest. It appears to give off a dark energy within the scales."),
	...
	FOCUS_SASH(81,0,0,new Color(232, 80, 80),Item.HELD_ITEM,null,"If the holder has full HP and it is hit with a move that should knock it out, it will endure with 1 HP—but only once."),
	AIR_BALLOON(82,0,0,new Color(232, 72, 72),Item.HELD_ITEM,null,"This balloon makes the holder float in the air. If the holder is hit with an attack, the balloon will burst."),
	POWER_HERB(83,0,0,new Color(253, 80, 77),Item.HELD_ITEM,null,"A herb that allows the holder to immediately use a move that normally requires a turn to charge—but only once."),
	WHITE_HERB(84,0,0,new Color(242, 242, 242),Item.HELD_ITEM,null,"A herb that will restore any lowered stat in battle—but only once."),
	WEAKNESS_POLICY(85,0,0,new Color(215, 233, 195),Item.HELD_ITEM,null,"If the holder is hit with a move it's weak to, this policy sharply boosts its Attack and Sp. Atk stats."),
	...
	CHERI_BERRY(221,10,0,new Color(232, 96, 80),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to free itself from paralysis."),
	CHESTO_BERRY(222,10,0,new Color(144, 112, 224),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to wake itself from sleep."),
	PECHA_BERRY(223,10,0,new Color(248, 192, 152),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to lift the effects of being poisoned from itself."),
	RAWST_BERRY(224,10,0,new Color(144, 208, 208),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to cure itself of a burn."),
	ASPEAR_BERRY(225,10,0,new Color(240, 224, 80),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to thaw itself from a frostbite."),
	LUM_BERRY(226,100,0,new Color(144, 216, 72),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to cure itself of any status condition it may have."),
	PERSIM_BERRY(227,10,0,new Color(224, 152, 112),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to cure itself of confusion."),
	LEPPA_BERRY(228,75,0,new Color(200, 72, 48),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 10 PP to a move."),
	ORAN_BERRY(229,25,0,new Color(80, 160, 240),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 10 HP to itself."),
	SITRUS_BERRY(230,50,0,new Color(248, 232, 104),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 25% of HP to itself."),
	WIKI_BERRY(231,75,0,new Color(144, 112, 224),Item.BERRY,null,"If a Pokémon holds one of these Berries, it will be able to restore 33% HP should it find itself in a pinch."),
	OCCA_BERRY(232,50,0,PType.FIRE.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Fire-type move, the power of that move will be weakened."),
	PASSHO_BERRY(233,50,0,PType.WATER.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Water-type move, the power of that move will be weakened."),
	WACAN_BERRY(234,50,0,PType.ELECTRIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Electric-type move, the power of that move will be weakened."),
	RINDO_BERRY(235,50,0,PType.GRASS.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Rindo-type move, the power of that move will be weakened."),
	YACHE_BERRY(236,50,0,PType.ICE.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Ice-type move, the power of that move will be weakened."),
	CHOPLE_BERRY(237,50,0,PType.FIGHTING.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Fighting-type move, the power of that move will be weakened."),
	KEBIA_BERRY(238,50,0,PType.POISON.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Poison-type move, the power of that move will be weakened."),
	SHUCA_BERRY(239,50,0,PType.GROUND.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Ground-type move, the power of that move will be weakened."),
	COBA_BERRY(240,50,0,PType.FLYING.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Flying-type move, the power of that move will be weakened."),
	PAYAPA_BERRY(241,50,0,PType.PSYCHIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Psychic-type move, the power of that move will be weakened."),
	TANGA_BERRY(242,50,0,PType.BUG.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Bug-type move, the power of that move will be weakened."),
	CHARTI_BERRY(243,50,0,PType.ROCK.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Rock-type move, the power of that move will be weakened."),
	KASIB_BERRY(244,50,0,PType.GHOST.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Ghost-type move, the power of that move will be weakened."),
	HABAN_BERRY(245,50,0,PType.DRAGON.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Dragon-type move, the power of that move will be weakened."),
	COLBUR_BERRY(246,50,0,PType.DARK.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Dark-type move, the power of that move will be weakened."),
	BABIRI_BERRY(247,50,0,PType.STEEL.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Steel-type move, the power of that move will be weakened."),
	CHILAN_BERRY(248,50,0,PType.NORMAL.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Normal-type move, the power of that move will be weakened."),
	ROSELI_BERRY(249,50,0,PType.LIGHT.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Light-type move, the power of that move will be weakened."),
	MYSTICOLA_BERRY(250,50,0,PType.MAGIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Magic-type move, the power of that move will be weakened."),
	GALAXEED_BERRY(251,50,0,PType.GALACTIC.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Galactic-type move, the power of that move will be weakened."),
	LIECHI_BERRY(252,150,0,new Color(248, 224, 160),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Attack stat will be boosted should it find itself in a pinch."),
	GANLON_BERRY(253,75,0,new Color(152, 144, 200),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Defense stat will be boosted should it find itself in a pinch."),
	SALAC_BERRY(254,200,0,new Color(120, 184, 112),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Speed stat will be boosted should it find itself in a pinch."),
	PETAYA_BERRY(255,150,0,new Color(240, 160, 120),Item.BERRY,null,"If a Pokémon holds one of these Berries, its Sp. Atk stat will be boosted should it find itself in a pinch."),
