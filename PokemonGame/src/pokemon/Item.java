...
public enum Item {
	...
	RINDO_BERRY(235,50,10,PType.GRASS.getColor(),Item.BERRY,null,"If a Pokémon holding this Berry is hit with a supereffective Rindo-type move, the power of that move will be weakened."),
