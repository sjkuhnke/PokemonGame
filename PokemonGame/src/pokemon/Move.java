...
public enum Move {
	...
	NIGHT_SHADE(0,100,0,-1,1,0,PType.GHOST,"Deals damage equal to user's level",false,15),
	...
	SEISMIC_TOSS(0,100,0,-1,0,0,PType.FIGHTING,"Damage dealt is equal to the user's level",true,20),
