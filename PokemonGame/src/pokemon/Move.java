...
public enum Move {
	...
	FATAL_BIND(75,85,100,0,0,0,PType.BUG,"% to cause the to faint in 3 turns",true,3),
	...
	FUTURE_SIGHT(120,100,0,-999,1,0,PType.PSYCHIC,"Attacks the foe 2 turns after this move is used",false,10),
