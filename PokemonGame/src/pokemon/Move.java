...
public enum Move {
	...
	FROSTBIND(0,90,0,0,2,0,PType.ICE,"Inflicts foe with Frostbite, accuracy is 100% for FIRE Pokemon",false,10),
	...
	ICE_FANG(65,95,20,0,0,0,PType.ICE,"% chance to Flinch and/or Frostbite foe",true,15),
	...
	KNOCK_OFF(-1,100,-1,0,0,0,PType.DARK,"Remove foe's item",true,15),
