...
public enum Move {
	...
	AQUA_VEIL(0,1000,0,0,2,4,PType.WATER,"User protects itself, can't be used in succession. Lowers foe's Attack and Sp.Atk by 1 if they make contact",false,5),
