...
public enum Ability {
	...
	COLD_HEART("The Pokemon drains the warmth and soul from the area, negating any PSYCHIC attacks."),
	...
	DJINN1S_FAVOR("Raises highest stat if hit by a MAGIC move."),
	...
	PRESSURE("The Pokemon raises opposing Pokemon's PP usage and resets any foe stat boosts on entry."),
	...
	WARM_HEART("The spiritual energy from this Pokemon melts away any ICE attacks."),
	...
	WHITE_HOLE("Distorts the energy of any DRAGON attack through and across Ultra Space."),
