...
public enum Ability {
	...
	INNER_FOCUS("The Pokemon is protected from flinching; ignores Intimidate and Terrify."),
	...
	SCRAPPY("The Pokemon can hit GHOST Pokemon with NORMAL and FIGHTING moves; ignores Intimidate and Terrify."),
