...
public class TileManager {
	...
	public TileManager(GamePanel gp) {
		...
		loadMap("/maps/e4_0.txt", 221, true);
		loadMap("/maps/e4_1.txt", 222, false);
		loadMap("/maps/e4_2.txt", 223, false);
	...
	public void getTileImage() {
		...
		setup(1152, true);
		setup(1153, true);
		setup(1154, true, TOP_HALF);
		setup(1155, false);
		setup(1156, true, TOP_HALF);
		setup(1157, true);
		setup(1158, true, TOP_HALF);
		setup(1159, false);
		setup(1160, false);
		setup(1161, false);
		setup(1162, true, TOP_HALF);
		setup(1163, true, LEFT_FOURTH);
		setup(1164, false);
		setup(1165, true, RIGHT_FOURTH);
		setup(1166, true, LEFT_FOURTH);
		setup(1167, false);
		setup(1168, true, RIGHT_FOURTH);
		setup(1169, false);
		setup(1170, false);
		setup(1171, false);
		setup(1172, false);
		setup(1173, false, OVER);
		setup(1174, true);
		setup(1175, true);
		setup(1176, true);
		setup(1177, true);
		...
		setup(1205, false);
		setup(1206, false);
		setup(1207, false, OVER);
		setup(1208, true, BOTTOM_THREE_FOURTHS);
		setup(1209, true, BOTTOM_LEFT_CORNER);
		setup(1210, true, BOTTOM_RIGHT_CORNER);
		setup(1211, true);
		setup(1212, true, LEFT_TWO_THIRDS);
		setup(1213, true, RIGHT_TWO_THIRDS);
		setup(1214, true);
		setup(1215, true, LEFT_TWO_THIRDS);
		setup(1216, true, RIGHT_TWO_THIRDS);
		setup(1217, true);
		setup(1218, true, LEFT_TWO_THIRDS);
		setup(1219, true, RIGHT_TWO_THIRDS);
		setup(1220, true, TOP_FOURTH);
		setup(1221, false);
		setup(1222, false);
		setup(1223, true);
		setup(1224, false);
		...
		setup(1245, false);
		setup(1246, false);
		setup(1247, false, OVER);
		setup(1248, true, BOTTOM_THREE_FOURTHS);
		setup(1249, true, BOTTOM_LEFT_CORNER);
		setup(1250, true, BOTTOM_RIGHT_CORNER);
		setup(1251, true);
		setup(1252, true, LEFT_TWO_THIRDS);
		setup(1253, true, RIGHT_TWO_THIRDS);
		setup(1254, true);
		setup(1255, true, LEFT_TWO_THIRDS);
		setup(1256, true, RIGHT_TWO_THIRDS);
		setup(1257, true);
		setup(1258, true, LEFT_TWO_THIRDS);
		setup(1259, true, RIGHT_TWO_THIRDS);
		setup(1260, true, TOP_FOURTH);
		setup(1261, false);
		setup(1262, false);
		setup(1263, true);
		setup(1264, false);
		...
		setup(1285, false);
		setup(1286, false);
		setup(1287, false, OVER);
		setup(1288, true, BOTTOM_THREE_FOURTHS);
		setup(1289, true, BOTTOM_LEFT_CORNER);
		setup(1290, true, BOTTOM_RIGHT_CORNER);
		setup(1291, true);
		setup(1292, true, LEFT_TWO_THIRDS);
		setup(1293, true, RIGHT_TWO_THIRDS);
		setup(1294, true);
		setup(1295, true, LEFT_TWO_THIRDS);
		setup(1296, true, RIGHT_TWO_THIRDS);
		setup(1297, true);
		setup(1298, true, LEFT_TWO_THIRDS);
		setup(1299, true, RIGHT_TWO_THIRDS);
		setup(1300, true, TOP_FOURTH);
		setup(1301, false);
		setup(1302, false);
		setup(1303, true, LEFT_TWO_THIRDS);
		setup(1304, false);
		setup(1305, false);
		setup(1306, false);
		setup(1307, false);
		...
		setup(1325, false);
		setup(1326, false);
		setup(1327, false, OVER);
		setup(1328, true, BOTTOM_THREE_FOURTHS);
		setup(1329, true, BOTTOM_LEFT_CORNER);
		setup(1330, true, BOTTOM_RIGHT_CORNER);
		setup(1331, true);
		setup(1332, true, LEFT_TWO_THIRDS);
		setup(1333, true, RIGHT_TWO_THIRDS);
		setup(1334, true);
		setup(1335, true);
		setup(1336, true, LEFT_TWO_THIRDS);
		setup(1337, true, RIGHT_TWO_THIRDS);
		setup(1338, true);
		setup(1339, true);
		setup(1340, true, LEFT_TWO_THIRDS);
		setup(1341, true, RIGHT_TWO_THIRDS);
		setup(1342, true);
		setup(1343, true);
		setup(1344, true, LEFT_TWO_THIRDS);
		setup(1345, true, RIGHT_TWO_THIRDS);
		setup(1346, true);
		setup(1347, true, TOP_FOURTH);
		setup(1348, false);
		setup(1349, false);
