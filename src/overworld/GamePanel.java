...
public class GamePanel extends JPanel implements Runnable {
	...
	public static final String GAME_VERSION = "0.8.9";
	...
	public static final int HALL_OF_FAME = 24;
	...
	private void saveScreenshot() {
		BufferedImage copy = new BufferedImage(screen.getWidth(), screen.getHeight(), BufferedImage.TYPE_INT_ARGB);
