...
public class PMap extends JPanel {
	...
	public static int getLoc(int map, int x, int y) {
		...
		case 126:
			...
			return 35;
		case 127:
			PlayerCharacter.currentMapName = "Casino";
			return 35;
		case 128:
			PlayerCharacter.currentMapName = "Rawwar City";
			return 35;
		case 129:
			PlayerCharacter.currentMapName = "Prize Shop";
			return 35;
		case 130:
			PlayerCharacter.currentMapName = "Rawwar City";
			return 35;
		...
		case 205:
			...
			return 38;
		case 206:
			PlayerCharacter.currentMapName = "Space Cavern (1A)";
			return -1;
		case 207:
		...
		case 209:
			...
			return -1;
		case 210:
			PlayerCharacter.currentMapName = "Mindagan Cavern (0B)";
			return 23;
		case 211:
		...
		case 227:
			...
			return 46;
		case 228:
			PlayerCharacter.currentMapName = "Research Post C";
			return 20;
		case 229:
			PlayerCharacter.currentMapName = "Research Post C";
			return 20;
