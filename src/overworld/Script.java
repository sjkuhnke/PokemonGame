...
public class Script {
	...
	private void initializeScripts() {
		...
		scriptMap.put(222.0, (npc) -> { // e4 whiskeroar
			if (!p.flag[8][5]) {
				...
				Task.addTask(Task.DIALOGUE, npc, "Heh, I see those stories aren't fairy tales after all. Fate holds no power over you, or your Pokemon.");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, gp.npc[222][1], "Yelp...");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.TURN, npc, "", Task.RIGHT);
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, npc, "Do not worry yourself, old friend. Victory and defeat are merely different sides of the same mountain, and we still have to climb nonetheless.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "Yet to spar with such skill against a human... Fido, you have proven your strength and skill a thousandfold, and I am honored to be your master.");
				Task.addTask(Task.SLEEP, "", 60);
				Task.addTask(Task.TURN, npc, "", player.getDirectionToFace());
				Task.addTask(Task.SLEEP, "", 45);
				Task.addTask(Task.DIALOGUE, npc, "As for you, trainer of hope... go, and etch your name in the annals of history. We await your success.");
			}
		});
		...
		scriptMap.put(223.0, (npc) -> { // e4 chlorie
			if (!p.flag[8][6]) {
				...
				addE4CutsceneTasks();
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, npc, "Right, leave those beakers on my desk, I need to clean them after this match, thanks!");
				Task.addTask(Task.SLEEP, "", 50);
				Task.addTask(Task.TURN, npc, "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.SPOT, npc, "");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, npc, "Wait, you're not...");
				Task.addTask(Task.DIALOGUE, npc, "OH! Uh, hello challenger!");
				Task.addTask(Task.DIALOGUE, npc, "You dare enter this perilous lab and face me, the chief scientific officer of this League?");
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.DIALOGUE, npc, "Ah, who am I kidding... I've lost all my aura, haven't I.");
				Task.addTask(Task.DIALOGUE, npc, "Well, a certain someone taught me to make the best from my worst. Let's see if you'll make a good reactant in my formula!");
				Task.addTask(Task.BATTLE, "", 536);
			} else {
				Task.addTask(Task.DIALOGUE, npc, "Foiled again... but I can tell that you've got the grit of a true precipitate.");
				Task.addTask(Task.DIALOGUE, npc, "Takes a real scientist to try over and over again... y'know?");
				Task.addTask(Task.DIALOGUE, npc, "Oh... you just remind me of...");
				Task.addTask(Task.DIALOGUE, npc, "...never mind. Well, what are you waiting for? You've got all the elements of success, so go out there and make your destiny.");
			}
		});
		...
		scriptMap.put(224.0, (npc) -> { // e4 astrid
			if (!p.flag[8][7]) {
				p.heal();
				addE4CutsceneTasks();
				Task.addTask(Task.DIALOGUE, npc, "So... what I wrote has come to pass.");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, npc, "Despite everything that has happened between me and your father, I wanted to make sure that you were ready for the trials to come.");
				Task.addTask(Task.DIALOGUE, npc, "As my son... I warn you that I won't be holding back. Though, I don't believe that will be an issue for the likes of you.");
				Task.addTask(Task.DIALOGUE, npc, "Ready yourself, trainer, and dive into the earth's core!");
				Task.addTask(Task.BATTLE, "", 537);
			} else {
				Task.addTask(Task.DIALOGUE, npc, "I... you've bested me. I've always hoped for this moment... but I... I...");
				Task.addTask(Task.DIALOGUE, npc, "I'm so proud of you, son. And from the depths of my soul, I know that your fathers, new and old, share my sentiment.");
				Task.addTask(Task.DIALOGUE, npc, "Even if we are apart now... you have always been our greatest accomplishment.");
				Task.addTask(Task.DIALOGUE, npc, "Now go. As the earth spins, so do the winds of time. Go and face your destiny.");
			}
		});
		...
		scriptMap.put(225.0, (npc) -> { // e4 arthra
			...
			if (!p.flag[8][8]) {
				...
				Task.addTask(Task.TURN, player, "", Task.UP);
				Task.addTask(Task.SLEEP, "", 45);
				Task.addTask(Task.DIALOGUE, npc, "Heh... guess I finally found my limit.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "All that talk about strength... about balance...");
				Task.addTask(Task.DIALOGUE, npc, "And your dumbass still came out on top.");
				Task.addTask(Task.SLEEP, "", 60);
				Task.addTask(Task.DIALOGUE, npc, "...");
				if (!p.flag[8][9]) {
					Task.addTask(Task.DIALOGUE, npc, "You remember what happened, right?");
					Task.addTask(Task.DIALOGUE, npc, "Logic. Faith. Two sides of the same coin... and we both got crushed trying to prove we were right.");
					Task.addTask(Task.SLEEP, "", 40);
					Task.addTask(Task.DIALOGUE, npc, "But standing here now... I get it.");
					Task.addTask(Task.DIALOGUE, npc, "It was never about choosing one.");
					Task.addTask(Task.DIALOGUE, npc, "It was about having the strength to carry both.");
					Task.addTask(Task.SLEEP, "", 30);
					Task.addTask(Task.TURN, npc, "", Task.UP);
					Task.addTask(Task.SLEEP, "", 40);
					Task.addTask(Task.TURN, npc, "", Task.DOWN);
					Task.addTask(Task.SLEEP, "", 20);
					Task.addTask(Task.DIALOGUE, npc, "Which is exactly why...");
					Task.addTask(Task.DIALOGUE, npc, "I can't keep this thing anymore.");
					Task.addTask(Task.SLEEP, "", 45);
					Task.addTask(Task.FLASH_IN, "");
					Task.addTask(Task.UPDATE, "");
					Task.addTask(Task.FLASH_OUT, "");
					...
					Task.addTask(Task.TURN, npc, "", Task.LEFT);
					Task.addTask(Task.SLEEP, "", 50);
					Task.addTask(Task.DIALOGUE, npc, "... you're free.");
					Task.addTask(Task.SLEEP, "", 80);
					Task.addTask(Task.DIALOGUE, npc, "No god deserves to be chained to someone still figuring themselves out.");
					Task.addTask(Task.DIALOGUE, npc, "Not even me.");
					Task.addTask(Task.SLEEP, "", 60);
					Task t = Task.addTask(Task.FLAG, ""); // flag for the cutscene
					t.start = 8;
					t.finish = 9;
					t = Task.addTask(Task.FLASH_IN, "");
					t.color = p.flag[7][9] ? new Color(114, 201, 224) : new Color(232, 111, 212);
					Task.addTask(Task.UPDATE, "");
					Task.addTask(Task.FLASH_OUT, "");
					Task.addTask(Task.SLEEP, "", 50);
					Task.addTask(Task.TURN, npc, "", Task.DOWN);
					Task.addTask(Task.SLEEP, "", 30);
					Task.addTask(Task.DIALOGUE, npc, "You still holding onto " + yourLegend + ", huh?");
					Task.addTask(Task.SLEEP, "", 20);
					Task.addTask(Task.DIALOGUE, npc, "Heh. Figures.");
					Task.addTask(Task.DIALOGUE, npc, "I'm not gonna pretend I like it...");
					Task.addTask(Task.DIALOGUE, npc, "But if it chose you? Then that's that.");
					Task.addTask(Task.SLEEP, "", 60);
					Task.addTask(Task.DIALOGUE, npc, "If you're serious about that whole 'balance' thing...");
					Task.addTask(Task.DIALOGUE, npc, "Then there's something you should know.");
					Task.addTask(Task.SLEEP, "", 30);
					Task.addTask(Task.DIALOGUE, npc, "When my grandpa... when Merlin fell...");
					Task.addTask(Task.DIALOGUE, npc, "He didn't just disappear.");
					Task.addTask(Task.DIALOGUE, npc, "His staff - his wand - it should still be back where it happened. At the temple where you guys awakened your legend.");
					Task.addTask(Task.SLEEP, "", 50);
					Task.addTask(Task.DIALOGUE, npc, "That thing isn't just some old relic. It's the key to walking both paths.");
					Task.addTask(Task.SLEEP, "", 40);
					t = Task.addTask(Task.ITEM, "");
					t.item = p.flag[7][9] ? Item.LOGIC_CORE : Item.FAITH_CORE;
					Task.addTask(Task.SLEEP, "", 55);
					Task.addTask(Task.DIALOGUE, npc, "With both cores... and Merlin's staff... you might actually be able to reach it.");
					Task.addTask(Task.DIALOGUE, npc, "Find my legend. And prove that balance isn't just something we say.");
					Task.addTask(Task.SLEEP, "", 60);
					Task.addTask(Task.DIALOGUE, npc, "But hey... that's after this, yeah?");
					Task.addTask(Task.DIALOGUE, npc, "You didn't climb all the way up here just to play errand boy.");
					t = Task.addTask(Task.FLAG, ""); // opposite faith/logic flag
					t.start = 7;
					t.finish = p.flag[7][9] ? 10 : 9;
				}
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "Champion's through that door. Don't keep them waiting.");
				if (!p.flag[8][15]) {
					Task.addTask(Task.SLEEP, "", 60);
					Task.addTask(Task.FLASH_IN, "");
					Task.addNPCMoveTask('y', 57 * gp.tileSize, gp.npc[225][2], false, 2016);
					Task.addTask(Task.FLASH_OUT, "");
					Task.addTask(Task.SLEEP, "", 20);
					Task.addTask(Task.DIALOGUE, gp.npc[225][2], "Hold it.");
					Task.addTask(Task.SLEEP, "", 10);
					Task.addTask(Task.TURN, player, "", Task.DOWN);
					Task.addTask(Task.SLEEP, "", 5);
					Task.addTask(Task.SPOT, player, "");
					Task.addTask(Task.SPOT, npc, "");
					Task.addTask(Task.SLEEP, "", 15);
					Task.addNPCMoveTask('y', 53 * gp.tileSize, gp.npc[225][2], false, 4);
					Task.addTask(Task.SLEEP, "", 10);
					Task.addTask(Task.DIALOGUE, npc, "I owe you both more than I can say.");
					Task.addTask(Task.DIALOGUE, npc, "You freed me. Freed all of us.");
					Task.addTask(Task.SLEEP, "", 40);
					Task.addTask(Task.DIALOGUE, npc, "So I'm not letting you walk in there blind.");
					Task.addTask(Task.DIALOGUE, npc, "Come on. I'll take you to the Champion myself.");
					Task.addTask(Task.SLEEP, "", 20);
					Task.addTask(Task.TURN, npc, "", Task.UP);
					Task.addTask(Task.SLEEP, "", 15);
					Task.addNPCMoveTask('y', 47 * gp.tileSize, npc, false, 4);
					Task.addTask(Task.SLEEP, "", 5);
					Task.addTask(Task.TURN, npc, "", Task.LEFT);
					Task.addTask(Task.SLEEP, "", 10);
					Task.addNPCMoveTask('x', 49 * gp.tileSize, npc, false, 4);
					Task.addTask(Task.SLEEP, "", 5);
					Task.addTask(Task.TURN, npc, "", Task.DOWN);
					Task.addTask(Task.SLEEP, "", 10);
					Task.addTask(Task.TURN, gp.npc[225][2], "", Task.RIGHT);
					Task.addTask(Task.SLEEP, "", 15);
					Task.addNPCMoveTask('x', 51 * gp.tileSize, gp.npc[225][2], false, 4);
					Task.addTask(Task.SLEEP, "", 5);
					Task.addTask(Task.TURN, gp.npc[225][2], "", Task.UP);
					Task.addTask(Task.SLEEP, "", 10);
					Task.addNPCMoveTask('y', 51 * gp.tileSize, gp.npc[225][2], false, 4);
					Task.addTask(Task.TURN, player, "", Task.RIGHT);
					Task.addNPCMoveTask('y', 49 * gp.tileSize, gp.npc[225][2], false, 4);
					Task.addTask(Task.TURN, player, "", Task.UP);
					Task.addNPCMoveTask('y', 47 * gp.tileSize, gp.npc[225][2], false, 4);
					Task.addTask(Task.SLEEP, "", 15);
					Task.addTask(Task.TURN, gp.npc[225][2], "", Task.DOWN);
					Task.addTask(Task.SLEEP, "", 20);
					Task.addNPCMoveTask('y', 48 * gp.tileSize, player, false, 4);
					Task.addTask(Task.SLEEP, "", 30);
					Task.addTask(Task.TURN, gp.npc[225][2], "", Task.LEFT);
					Task.addTask(Task.SLEEP, "", 5);
					Task.addTask(Task.TURN, npc, "", Task.RIGHT);
					Task.addTask(Task.SLEEP, "", 10);
					Task.addNPCMoveTask('x', 50 * gp.tileSize, gp.npc[225][2], false, 4);
					Task.addTask(Task.SLEEP, "", 15);
					Task.addTask(Task.TURN, gp.npc[225][2], "", Task.UP);
					Task.addTask(Task.SLEEP, "", 20);
					Task.addNPCMoveTask('y', 46 * gp.tileSize + gp.tileSize/2, gp.npc[225][2], false, 2);
					Task.addTask(Task.FLASH_IN, "");
					Task.addNPCMoveTask('y', 1 * gp.tileSize, gp.npc[225][2], false, 2184);
					Task.addTask(Task.FLASH_OUT, "");
					Task.addTask(Task.SLEEP, "", 30);
					Task.addNPCMoveTask('y', 46 * gp.tileSize + gp.tileSize/2, player, false, 2);
					Task t = Task.addTask(Task.TELEPORT, "");
					t.counter = 226;
					t.start = 50;
					t.finish = 57;
		...
		scriptMap.put(226.0, (npc) -> { // e4 ryder
			if (!p.flag[8][10]) {
				p.heal();
				Task.addTask(Task.TURN, gp.npc[226][1], "", Task.DOWN);
				Task.addTask(Task.TURN, gp.npc[226][2], "", Task.UP);
				Task.addTask(Task.TURN, gp.npc[226][3], "", Task.UP);
				...
				Task.addTask(Task.SLEEP, "", 60);
				Task.addTask(Task.DIALOGUE, npc, "Hehehe... HAHAHAHAHAHA!!");
				Task.addTask(Task.DIALOGUE, npc, "Now THAT... was a battle!");
				Task.addTask(Task.DIALOGUE, npc, "The stakes, the moves, the sheer skill!");
				Task.addTask(Task.DIALOGUE, npc, "I haven't been pushed to my limits since... well, this league ain't my first rodeo.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "But no doubt about it... you're the real deal.");
				Task.addTask(Task.DIALOGUE, npc, "Champion level. Built from the ground up.");
				Task.addTask(Task.SLEEP, "", 40);
				Task.addTask(Task.DIALOGUE, npc, "Congratulations, kid. You've earned this.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.SHAKE, gp.npc[226][5], "Grrrrghhh...", 60);
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.TURN, npc, "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.DIALOGUE, npc, "Easy there.");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.FLASH_IN, "");
				Task.addNPCMoveTask('x', gp.tileSize * 47, gp.npc[226][4], false, 192);
				Task.addTask(Task.TURN, gp.npc[226][4], "", Task.RIGHT);
				Task.addTask(Task.FLASH_OUT, "");
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.DIALOGUE, gp.npc[226][4], "*pat*");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.TURN, gp.npc[226][5], "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 60);
				Task.addTask(Task.FLASH_IN, "");
				...
				Task.addTask(Task.DIALOGUE, npc, "Considering what it did in Alola, I'm doing a favor for those islands.");
				Task.addTask(Task.SLEEP, "", 60);
				Task.addTask(Task.DIALOGUE, npc, "Well, a fitting end to this story.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "C'mon.");
				Task.addTask(Task.DIALOGUE, npc, "Let's make it official.");
				Task.addTask(Task.SLEEP, "", 40);
				Task.addTask(Task.FLASH_IN, "");
				Task.addNPCMoveTask('y', gp.tileSize, npc, false, 2448);
				Task.addNPCMoveTask('y', gp.tileSize, gp.npc[226][4], false, 2448);
				...
				t.wipe = false;
				Task.addTask(Task.SLEEP, "", 15);
				Task.addNPCMoveTask('y', 54 * gp.tileSize, player, false, 2);
				Task.addTask(Task.SLEEP, "", 60);
				Task.addTask(Task.DIALOGUE, gp.npc[227][0], "This is it.");
				Task.addTask(Task.DIALOGUE, gp.npc[227][0], "Every champion ends up here eventually.");
				Task.addTask(Task.SLEEP, "", 90);
				Task.addNPCMoveTask('y', 52 * gp.tileSize + gp.tileSize/4, gp.npc[227][3], false, 4);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[227][3], "...Heh.");
				Task.addTask(Task.DIALOGUE, gp.npc[227][3], "Guess I really did bet on the right person.");
				Task.addTask(Task.SLEEP, "", 45);
				Task.addNPCMoveTask('y', 51 * gp.tileSize + gp.tileSize/4, gp.npc[227][2], false, 4);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[227][2], "You didn't just win... you saved everything.");
				Task.addTask(Task.SLEEP, "", 120);
				Task.addNPCMoveTask('y', 52 * gp.tileSize + gp.tileSize/4, gp.npc[227][4], false, 4);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[227][4], "I always knew you'd make it.");
				Task.addTask(Task.SLEEP, "", 150);
				Task.addNPCMoveTask('y', 50 * gp.tileSize + gp.tileSize*2/3, player, false, 2);
				Task.addTask(Task.SLEEP, "", 5);
				Task.addTask(Task.TURN, gp.npc[227][0], "", Task.LEFT);
				Task.addTask(Task.TURN, gp.npc[227][1], "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 10);
				Task.addTask(Task.TURN, gp.npc[227][2], "", Task.RIGHT);
				Task.addTask(Task.SLEEP, "", 5);
				Task.addTask(Task.TURN, gp.npc[227][3], "", Task.RIGHT);
				Task.addTask(Task.TURN, gp.npc[227][4], "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 30);
				for (int i = 0; i < p.team.length; i++) {
					if (p.team[i] != null) {
						t = Task.addTask(Task.LOAD, "");
						t.start = 227;
						t.finish = 0;
						Task.addTask(Task.SLEEP, "", 45);
					}
				...
				Task.addTask(Task.SLEEP, "", 60);
				Task.addParticleTask(gp.npc[227][1], "smoke", PType.PSYCHIC.getColor(), 50);
				Task.addTask(Task.SLEEP, "", 75);
				Task.addTask(Task.DIALOGUE, gp.npc[227][1], "Let the record be written.", 2);
				Task.addTask(Task.DIALOGUE, gp.npc[227][1], "<@>...", 2);
				Task.addTask(Task.DIALOGUE, gp.npc[227][1], "Champion of Xhenos!", 2);
				Task.addTask(Task.SLEEP, "", 120);
				t = Task.addTask(Task.FLASH_IN, "");
				t.color = Color.BLACK;
				Task.addTask(Task.GAME_STATE, "", 24);
			}
		});
		
		scriptMap.put(226.1, (npc) -> { // e4 previous champion
			if (!p.flag[8][15]) {
				Task.addTask(Task.SLEEP, "", 45);
				Task.addNPCMoveTask('y', 56 * gp.tileSize, player, false, 4);
				Task.addTask(Task.SLEEP, "", 5);
				Task.addTask(Task.TURN, player, "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 10);
				Task.addTask(Task.FLASH_IN, "");
				Task.addNPCMoveTask('y', 57 * gp.tileSize, gp.npc[226][3], false, 2016);
				Task.addTask(Task.FLASH_OUT, "");
				Task.addTask(Task.SLEEP, "", 10);
				Task.addTask(Task.TURN, gp.npc[226][3], "", Task.RIGHT);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addNPCMoveTask('x', 51 * gp.tileSize, gp.npc[226][3], false, 4);
				Task.addTask(Task.SLEEP, "", 10);
				Task.addTask(Task.TURN, gp.npc[226][3], "", Task.UP);
				Task.addTask(Task.SLEEP, "", 5);
				Task.addTask(Task.TURN, gp.npc[226][2], "", Task.UP);
				...
				Task.addTask(Task.TURN, player, "", Task.UP);
				Task.addTask(Task.SLEEP, "", 50);
				Task.addNPCMoveTask('y', 53 * gp.tileSize + gp.tileSize / 2, player, false, 2);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, npc, "...I lost.");
				Task.addTask(Task.DIALOGUE, npc, "After all this time... someone finally surpassed me.");
				Task.addTask(Task.SLEEP, "", 45);
				Task.addTask(Task.DIALOGUE, npc, "The title of Champion... it belongs to you now -");
				Task.addTask(Task.TURN, gp.npc[226][4], "", Task.DOWN);
				Task.addTask(Task.SPOT, gp.npc[226][4], "");
				Task.addTask(Task.SLEEP, "", 10);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.SPOT, gp.npc[226][0], "");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Well... well... you made it.");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Told you I'd see how this story ends.");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addNPCMoveTask('y', 54 * gp.tileSize, gp.npc[226][3], false, 4);
				Task.addTask(Task.SLEEP, "", 20);
				Task.addNPCMoveTask('y', 51 * gp.tileSize + gp.tileSize / 2, gp.npc[226][0], false, 2);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "And I was right to trust you with those friends of mine.");
				Task.addTask(Task.SLEEP, "", 5);
				Task.addNPCMoveTask('y', 54 * gp.tileSize, gp.npc[226][2], false, 4);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][2], "You... I... I watched you explode!");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, gp.npc[226][3], "...No way.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Yeah, well -");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "My death was... greatly exaggerated.");
				Task.addTask(Task.SLEEP, "", 60);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Still... standing here like this... feels right.");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "You ever get that feeling?");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Like every step you took - every battle, every loss - was leading to one exact moment?");
				Task.addTask(Task.SLEEP, "", 50);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Yeah. This is mine.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.TURN, gp.npc[226][4], "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, gp.npc[226][4], "Kaff! Kaff!", 2);
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Again.");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.RIGHT);
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Geez, you sure love your technicalities, bud.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.TURN, gp.npc[226][4], "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Anyways, so before you go taking that title...");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addNPCMoveTask('y', 52 * gp.tileSize, gp.npc[226][0], false, 4);
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "You're gonna have to get through me.");
				Task.addTask(Task.SLEEP, "", 45);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Because I already did.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "...It's true.");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.UP);
				Task.addTask(Task.TURN, gp.npc[226][4], "", Task.UP);
				Task.addTask(Task.SLEEP, "", 10);
				Task.addTask(Task.TURN, npc, "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addNPCMoveTask('x', 49 * gp.tileSize, npc, false, 2);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.TURN, npc, "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 25);
				Task.addNPCMoveTask('y', 51 * gp.tileSize, npc, false, 2);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.LEFT);
				Task.addTask(Task.TURN, gp.npc[226][4], "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "He defeated me.");
				Task.addTask(Task.DIALOGUE, npc, "The throne already has a new king.");
				Task.addTask(Task.SLEEP, "", 40);
				Task.addTask(Task.TURN, gp.npc[226][4], "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "And yeah... I didn't do it alone.");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.SHAKE, "", 120);
				Task.addNPCMoveTask('y', 50 * gp.tileSize, npc, false, 4);
				Task.addTask(Task.FLASH_IN, "");
				Task.addNPCMoveTask('x', 48 * gp.tileSize + gp.tileSize/2, gp.npc[226][5], false, 2280);
				Task.addTask(Task.FLASH_OUT, "");
				Task.addTask(Task.SHAKE, "", 70);
				Task.addTask(Task.SLEEP, "", 5);
				Task.addNPCMoveTask('y', 54 * gp.tileSize + gp.tileSize/2, gp.npc[226][2], false, 4);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][2], "That thing again?!");
				Task.addTask(Task.SLEEP, "", 10);
				Task.addNPCMoveTask('y', 54 * gp.tileSize + gp.tileSize/2, gp.npc[226][3], false, 4);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][3], "So that's what survived out there.");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Necrozma.");
				Task.addTask(Task.SLEEP, "", 10);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.LEFT);
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Ancient. Starving. Angry as hell.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.TURN, gp.npc[226][0], "", Task.DOWN);
				Task.addTask(Task.SLEEP, "", 5);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "When it went after me... I didn't run.");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "I fought it.");
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "And just like you... I didn't back down from something bigger than me.");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "So yeah. It stuck around.");
				Task.addTask(Task.SLEEP, "", 40);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "But don't get it twisted.");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "I didn't come here to monologue.");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "I came here for one last real fight.");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "You've beaten legends.");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "You've saved the world.");
				Task.addTask(Task.DIALOGUE, gp.npc[226][0], "Now prove you can beat ME: because I've already done that and more!");
				Task t = Task.addTask(Task.FLAG, "");
				t.start = 8;
				t.finish = 15;
			} else {
				Task.addTask(Task.DIALOGUE, npc, "Funny, isn't it?");
				Task.addTask(Task.DIALOGUE, npc, "For years, I stood in the heart of this mountain convinced no one could reach me.");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, npc, "Then you did.");
				Task.addTask(Task.DIALOGUE, npc, "And before I could even hand you the crown... Ryder took it first.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "I should be bitter. But honestly? I'm relieved.");
				Task.addTask(Task.DIALOGUE, npc, "A Champion who fears being surpassed was never worthy of the title to begin with.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "Ryder fights like a man who's already died once and decided that wasn't enough.");
				Task.addTask(Task.DIALOGUE, npc, "And you... you fight like someone with an entire world behind them.");
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.DIALOGUE, npc, "That makes this battle important.");
				Task.addTask(Task.DIALOGUE, npc, "Not for the title. Titles are temporary.");
				Task.addTask(Task.DIALOGUE, npc, "For proof.");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, npc, "Proof that this region really is safe in your hands.");
				Task.addTask(Task.SLEEP, "", 30);
				Task.addTask(Task.DIALOGUE, npc, "So go.");
				Task.addTask(Task.DIALOGUE, npc, "Defeat him.");
				Task.addTask(Task.DIALOGUE, npc, "Become the Champion Xhenos deserves.");
				Task.addTask(Task.SLEEP, "", 25);
				Task.addTask(Task.DIALOGUE, npc, "And after that...");
				Task.addTask(Task.SLEEP, "", 15);
				Task.addTask(Task.DIALOGUE, npc, "Come find me.");
				Task.addTask(Task.DIALOGUE, npc, "A throne may be temporary...");
				Task.addTask(Task.DIALOGUE, npc, "...but strength never retires.");
				Task.addTask(Task.SLEEP, "", 20);
				Task.addTask(Task.DIALOGUE, npc, "When that day comes, I won't be holding back.");
			}
		});
		
		scriptMap.put(226.2, (npc) -> { // nova champ room
			Task.addTask(Task.DIALOGUE, npc, "I still cannot believe he survived that.");
			Task.addTask(Task.DIALOGUE, npc, "You humans are either incredibly resilient... or incredibly stupid.");
			Task.addTask(Task.SLEEP, "", 10);
			Task.addTask(Task.DIALOGUE, npc, "Probably both.");
			Task.addTask(Task.SLEEP, "", 20);
			Task.addTask(Task.DIALOGUE, npc, "Still... if Ryder trusts you enough to stand here, then I do too.");
			Task.addTask(Task.DIALOGUE, npc, "Beat him.");
			Task.addTask(Task.SLEEP, "", 15);
			Task.addTask(Task.DIALOGUE, npc, "Also, if Necrozma starts glowing?");
			Task.addTask(Task.DIALOGUE, npc, "That is very bad. Please do not die.");
		});
		
		scriptMap.put(226.3, (npc) -> { // arthra champ room
			Task.addTask(Task.DIALOGUE, npc, "Well, look at us.");
			Task.addTask(Task.DIALOGUE, npc, "From Ghostly Woods to the Champion room.");
			Task.addTask(Task.DIALOGUE, npc, "Honestly? I thought one of us would've died way earlier.");
			Task.addTask(Task.SLEEP, "", 25);
			Task.addTask(Task.DIALOGUE, npc, "Probably you.");
			Task.addTask(Task.SLEEP, "", 15);
			Task.addTask(Task.DIALOGUE, npc, "But you're still here.");
			Task.addTask(Task.DIALOGUE, npc, "And if anyone's gonna beat that washed-up space cowboy, it should be you.");
			Task.addTask(Task.SLEEP, "", 20);
			Task.addTask(Task.DIALOGUE, npc, "Don't embarrass me.");
			Task.addTask(Task.DIALOGUE, npc, "Because if you lose, I have to pretend I like Ryder more than you.");
		});
		
		scriptMap.put(226.4, (npc) -> { // alakazam champ room
			Task.addTask(Task.DIALOGUE, npc, "Vxxxvhh...");
			Task.addTask(Task.SLEEP, "", 25);
			Task.addTask(Task.DIALOGUE, npc, "His mind is clear. His resolve is absolute.", 2);
			Task.addTask(Task.SLEEP, "", 20);
			Task.addTask(Task.DIALOGUE, npc, "This battle matters to him. Not for glory. Not for power.", 2);
			Task.addTask(Task.DIALOGUE, npc, "For closure.", 2);
			Task.addTask(Task.SLEEP, "", 20);
			Task.addTask(Task.DIALOGUE, npc, "Give him the battle he seeks.", 2);
			Task.addTask(Task.SLEEP, "", 15);
			Task.addTask(Task.DIALOGUE, npc, "And do not underestimate me.", 2);
			Task.addTask(Task.DIALOGUE, npc, "I have grown rather fond of winning.", 2);
		});
		
		scriptMap.put(226.5, (npc) -> { // necrozma champ room
			Task.addTask(Task.SHAKE, npc, "Grrrraaaahhh...!", 90);
			Task.addTask(Task.SLEEP, "", 45);
			Task.addTask(Task.TEXT, "The prism beast stares through you.");
			Task.addTask(Task.SLEEP, "", 30);
			Task.addTask(Task.SHAKE, npc, "Kshhhrrr... VROOOHHH!", 120);
		});
	}
	...
	private void addE4CutsceneTasks() {
		...
		if (player.worldX < 50 * gp.tileSize) {
			Task.addTask(Task.TURN, player, "", Task.RIGHT);
			pause = true;
		} else if (player.worldX > 50 * gp.tileSize) {
			Task.addTask(Task.TURN, player, "", Task.LEFT);
			pause = true;
		}
		Task.addNPCMoveTask('x', gp.tileSize * 50, player, false, 4);
		if (pause) Task.addTask(Task.SLEEP, "", 20);
		Task.addTask(Task.TURN, player, "", Task.UP);
		if (pause) Task.addTask(Task.SLEEP, "", 30);
		Task.addNPCMoveTask('y', gp.tileSize * 51, player, false, 4);
		Task.addTask(Task.SLEEP, "", 45);
	}
