...
public enum Item {
	...
	ELECTRIC_SEED(334,2,250,Color.BLACK,Item.HELD_ITEM,1,"If the terrain becomes Electric Terrain, the holder will use this seed to boost its own Defense stat."),
	GRASSY_SEED(335,2,250,Color.BLACK,Item.HELD_ITEM,1,"If the terrain becomes Grassy Terrain, the holder will use this seed to boost its own Defense stat."),
	PSYCHIC_SEED(336,2,250,Color.BLACK,Item.HELD_ITEM,1,"If the terrain becomes Psychic Terrain, the holder will use this seed to boost its own Sp. Def stat."),
	SPARKLY_SEED(337,2,250,Color.BLACK,Item.HELD_ITEM,1,"If the terrain becomes Sparkly Terrain, the holder will use this seed to boost its own Sp. Def stat."),
	...
	ADRENALINE_ORB(326,1,75,Color.BLACK,Item.HELD_ITEM,1,"This orb will boost the Speed of the Pokemon by 1 stage when it is intimidated, threatened or terrified."),
