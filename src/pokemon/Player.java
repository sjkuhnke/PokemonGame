...
public class Player extends Trainer implements Serializable {
	...
	public JPanel displayTweaker() {
		...
		String[][] flagDesc = {
			...
			{"Nova Ship", "Robin Letter", "Dad Scene", "Scott 5", "Fred 5", "Fighting E4", "Poison E4", "Ground E4", "Steel E4", "Arthra Scene", "Champion", "Space Back", "Mystery Peak", "Perilyte 1", "Third Starter", "Champ Scene", "", "", "", "", "", "", "", ""},			
		};
...
//		public boolean[] coinBadges;
	...
	public void startBattleRecord(Trainer t) {
		currentBattle = new BattleRecord(t.getName(), team, difficulty + 1, badges);
	}
	...
	public void recordPPUse(Pokemon pokemon, Move move, int amt) {
		if (currentBattle != null) {
			currentBattle.recordPPUse(pokemon, move, amt);
		}
	}
	
	public void recordDamageDealt(Pokemon pokemon, double percent) {
		if (currentBattle != null) {
			currentBattle.recordDamageDealt(pokemon, percent);
		}
	}
	
	public void recordDamageTaken(Pokemon pokemon, double percent) {
		if (currentBattle != null) {
			currentBattle.recordDamageTaken(pokemon, percent);
		}
	}
