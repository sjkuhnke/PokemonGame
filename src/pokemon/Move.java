...
public enum Move {
	...
	AQUA_RING(0,1000,0,0,2,0,PType.WATER,"Restores 1/16 of max HP at the end of every turn",false,15),
	...
	BLACK_HOLE_ECLIPSE(140,100,0,0,1,0,PType.GALACTIC,"Raises user's Sp.Def by 1, user must charge on the first turn",false,5),
	...
	BURN_UP(115,100,-1,0,1,0,PType.FIRE,"Causes user to lose its FIRE type if it has it",false,5),
	...
	CHANNELING_BLOW(75,100,0,4,0,0,PType.FIGHTING,"This move always crits",true,15),
	...
	CHROMO_BEAM(80,100,0,0,1,0,PType.LIGHT,"30% chance to double in Base Power; chance can't be nullified, effected by Serene Grace/Sparkly Terrain",false,5),
	...
	COMET_PUNCH(55,100,0,0,0,0,PType.GALACTIC,"Raises user's Speed by 2 if it faints the foe",true,15),
	...
	CURSE(0,1000,0,0,2,0,PType.GHOST,"If user is GHOST type: User loses 1/2 max HP, then foe loses 1/4 max HP at the end of every turn; if not GHOST type: Raises user's Attack, Defense by 1 but lowers user's Speed by 1",false,10),
	CUT(55,95,0,4,0,0,PType.NORMAL,"This move always crits",true,20),
	...
	DRACO_METEOR(130,90,-1,0,1,0,PType.DRAGON,"Lowers user's Sp.Atk by 2",false,5),
	DRAGON_ASCENT(120,100,-1,0,0,0,PType.FLYING,"Lowers user's Defense and Sp.Def by 1",true,5),
	...
	DUAL_CHOP(40,100,0,1,0,0,PType.DRAGON,"Attacks twice, each hit has a boosted crit rate",true,15),
	...
	FATAL_BIND(75,85,100,0,0,0,PType.BUG,"% to cause the foe to faint in 3 turns",true,3),
	...
	FIRE_SPIN(35,85,100,0,1,0,PType.FIRE,"% to spin the foe for 4-5 turns. While foe is spun, it takes 1/8 HP in damage, and cannot switch",false,15),
	...
	FOCUS_ENERGY(0,1000,0,0,2,0,PType.NORMAL,"Boosts the user's crit rate by 2 (max crit rate is 3)",false,20),
	...
	FROSTBIND(0,90,0,0,2,0,PType.ICE,"Inflicts foe with Frostbite, accuracy is 100% for ICE Pokemon",false,10),
	...
	HAMMER_ARM(100,100,-1,0,0,0,PType.FIGHTING,"Lower user's speed by 1",true,10),
	...
	HEALING_WISH(0,1000,0,0,2,0,PType.PSYCHIC,"User faints. The next damaged Pokemon sent in will be fully healed",false,5),
	...
	HORN_DRILL(0,30,0,-999,0,0,PType.NORMAL,"If this move hits, it always K.Os foe",true,5),
	...
	HURRICANE(110,70,30,0,1,0,PType.FLYING,"% chance to confuse foe, doesn't check Accuracy in RAIN, 50% accuracy in SUN",false,10),
	...
	METEOR_BEAM(120,100,0,0,1,0,PType.ROCK,"Raises user's Sp.Atk by 1, user must charge on the first turn",false,10),
	...
	MIMIC(0,1000,0,0,2,0,PType.NORMAL,"Uses the move last used by the foe and replaces Mimic in the user's moveset for the rest of the battle",false,10),
	...
	OVERHEAT(130,90,-1,0,1,0,PType.FIRE,"Lowers user's Sp.Atk by 2",false,5),
	...
	PHOTON_DRAIN(100,100,0,0,1,0,PType.DARK,"Super effective against LIGHT types too",false,10),
	...
	POISON_GAS(0,90,0,0,2,0,PType.POISON,"Poisons foe",false,30),
	...
	SCALE_SHOT(25,90,-1,0,0,0,PType.DRAGON,"Lowers user's Defense by 1 and raise user's Speed by 1. Hits 2-5 times",false,20),
	...
	SEISMIC_TOSS(0,100,0,-999,0,0,PType.FIGHTING,"Damage dealt is equal to the user's level",true,20),
	...
	SKYBURN(120,100,0,0,1,0,PType.LIGHT,"Always STAB, will be either LIGHT or GALACTIC type, whichever deals more damage",false,5),
	...
	SNOW_PLUME(80,100,30,0,1,0,PType.ICE,"% to Frostbite foe",false,15),
	...
	SPECTRAL_THIEF(90,100,100,0,0,0,PType.GHOST,"% to steal any stat boosts foe has unless move faints foe",true,10),
	...
	STAR_STORM(110,85,30,0,1,0,PType.GALACTIC,"% to raise user's crit rate by 1",false,5),
	STAR$STRUCK_ARROW(75,85,0,4,0,0,PType.GALACTIC,"This move always crits",false,10),
	...
	STEEL_BEAM(140,95,0,0,1,0,PType.STEEL,"Deals 1/2 of user's max HP in recoil",false,5),
	...
	STORM_THROW(60,100,0,4,0,0,PType.FIGHTING,"This move always crits",true,10),
	...
	SUMMIT_STRIKE(70,100,100,0,0,0,PType.FIGHTING,"% to lower foe's Defense by one stage.",true,15),
	...
	WATERFALL(80,100,20,0,0,0,PType.WATER,"% of causing foe to flinch",true,10),
	...
	WHIRLPOOL(35,95,100,0,1,0,PType.WATER,"% to spin the foe for 4-5 turns. While foe is spun, it takes 1/8 HP in damage, and cannot switch",false,15),
	...
	MAGNITUDE_4(10,100,0,0,0,0,PType.GROUND,"Calc only move",false,25),
	MAGNITUDE_5(30,100,0,0,0,0,PType.GROUND,"Calc only move",false,25),
	MAGNITUDE_6(50,100,0,0,0,0,PType.GROUND,"Calc only move",false,25),
	MAGNITUDE_7(70,100,0,0,0,0,PType.GROUND,"Calc only move",false,25),
	MAGNITUDE_8(90,100,0,0,0,0,PType.GROUND,"Calc only move",false,25),
	MAGNITUDE_9(110,100,0,0,0,0,PType.GROUND,"Calc only move",false,25),
	MAGNITUDE_10(150,100,0,0,0,0,PType.GROUND,"Calc only move",false,25),
	;
