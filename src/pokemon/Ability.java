...
public enum Ability {
	...
	BRAINWASH("Makes all stat changes have an opposite effect while on the field."),
	BULLETPROOF("Protects the Pokemon from projectile moves."),
	...
	GOOEY("Damaging the Pokemon lowers the attacker's Speed stat."),
	...
	NEUROFORCE("Restores 1/3 of max HP when hit by a LIGHT move, super effective moves get a 1.5x boost when used by this Pokemon."),
	...
	SAND_FORCE("Boosts the power of moves in a SANDSTORM by 1.3x; immune to sand damage."),
	SAND_RUSH("Doubles the Pokemon's Speed stat in a SANDSTORM; immune to sand damage."),
	SAND_STREAM("The Pokemon summons a SANDSTORM for 5 turns when it enters a battle; immune to sand damage."),
	SAND_VEIL("Opposing moves are 0.8x accurate while SANDSTORM is active; immune to sand damage."),
